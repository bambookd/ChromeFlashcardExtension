...
3. **Interactive Practice Phase**: The Study Web App loads user flashcards from DynamoDB via authenticated REST calls, managing local study queues and recall scores.
