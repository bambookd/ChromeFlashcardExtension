...
| Week | Date Range | Main Focus / Milestones | Key Deliverable | Status |
| --- | --- | --- | --- | --- |
| [Week 1](1.1-week1/) | 15/06 – 21/06/2026 | Onboarding, AWS account setup, team formation, alignment, project kickoff | Team charter & scope boundary | Done |
| [Week 2](1.2-week2/) | 22/06 – 28/06/2026 | AWS service exploration, problem framing, first Chrome Extension build | Manifest V3 prototype (local storage) | Done |
| [Week 3](1.3-week3/) | 29/06 – 05/07/2026 | Study session engine, category management, Express.js API, DynamoDB SAM draft | `template.yaml` + local Express backend | Done |
