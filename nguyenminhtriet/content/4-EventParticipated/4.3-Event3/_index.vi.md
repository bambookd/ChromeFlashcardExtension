...
# Sự kiện 3 (Tham gia trực tuyến) - FCAJ x Agentic AI Build Week: Show Up. Build. Pitch. WIN! - 25/07/2026
...
Từ Sự kiện 3, mình hiểu rằng Agentic AI đang thay đổi quá trình phát triển phần mềm từ việc viết logic theo từng dòng mã sang thiết kế và điều phối toàn bộ hệ thống.
...
Sau Sự kiện 3, mình kỳ vọng sẽ tiếp tục tìm hiểu cách phát triển Agentic AI an toàn và chuyển đổi các nguyên mẫu thành hệ thống sẵn sàng cho môi trường production.
