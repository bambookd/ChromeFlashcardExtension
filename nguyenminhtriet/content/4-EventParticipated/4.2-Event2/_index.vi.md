...
# Bài thu hoạch Sự kiện 2 (Tham gia trực tiếp) - AWS Cloud, Monitoring và Bảo mật ứng dụng - 11/07/2026

## 1. Tổng quan

Sự kiện kỹ thuật tập trung vào các cam kết mức dịch vụ (SLA), khả năng quan sát hệ thống (observability), chiến lược luyện thi chứng chỉ AWS và đánh giá bảo mật ứng dụng tự động.

Mục tiêu chính giúp người tham dự hiểu rằng các chỉ số hạ tầng xanh chưa bảo đảm trải nghiệm tốt cho người dùng, đồng thời các cơ chế bảo mật cần được tích hợp xuyên suốt toàn bộ vòng đời phát triển phần mềm.
